...
export default class EventRepository
{
    ...
    updateAsync = async (entity) =>
    {
        let returnArray = null;
        const sql = `
        Update events Set name=$2, description=$3, id_event_category=$4, id_event_location=$5, start_date=$6, duration_in_minutes=$7, price=$8, enabled_for_enrollment=$9, max_assistance=$10, id_creator_user=$11
        Where id = $1`;
